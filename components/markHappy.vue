...
<template>
    <div ref="target" class="flex items-center justify-center p-4">
        <div class="flex flex-col items-center justify-center h-full gap-4 lg:max-w-6xl lg:gap-20">
            ...
            <div class="flex flex-col items-center justify-center h-full gap-4 lg:h-auto lg:flex-row lg:gap-10">
                ...
                <div :class="textClass" class="transition-transform duration-1000 h-2/3 sm:h-1/2 lg:h-auto lg:w-2/3">
                    <ul class="pl-4 space-y-1 list-disc lg:space-y-2 lg:pl-0 text-text sm:text-subtitle text-secondary">
                        <li>{{ t("p7.2") }}</li>
                        <li>{{ t("p7.3") }}</li>
                        <li>{{ t("p7.4") }}</li>
                        <li>{{ t("p7.5") }}</li>
